...
const APP_NAME = "Attic Vent Calc";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Interactive attic ventilation calculator for IRC R806 and manufacturer net free area — soffit, ridge, gable, turbine, dome, and solar vents.",
      },
