...
export function pwaDisplayName(hostHeader, site = readOgSite()) {
...
export function renderInstallPageHtml(template, { host, url, site } = {}) {
  const name = pwaDisplayName(host, site ?? readOgSite());
...
export function renderWebManifest(hostHeader, site = readOgSite()) {
  const name = pwaDisplayName(hostHeader, site);
