...
All 9 pages still say **"BigBoss Roofing LLC"** and use the email `info@bigbossroofing.com` in the
estimate form and footer — this looks like placeholder/demo branding, not your real business name
or domain. Flagging this in case it needs to be swapped before publishing; I didn't change it since
that's a content decision, not a structural fix.
